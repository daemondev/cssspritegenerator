...
//                        
////                        datos = new HashMap();                                            
////                        datos.put("imageName", fileName);
////                        datos.put("posX", 0);
////                        datos.put("posY", io.getHeight()+margin);                        
////                        arrData.add(datos);
...
//                        
//                        
//                        css += fileName+" {background: transparent url('"+outputFile+"') 0px "+(io.getHeight()+margin)+";}\n";
//                        
...
//    Font fnt_label = new Font("Cambria", 2, 20);
//
