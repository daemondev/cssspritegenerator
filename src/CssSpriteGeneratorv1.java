...
public class CssSpriteGeneratorv1 extends JFrame implements ActionListener {
...
//        BufferedImage sprite = new BufferedImage(maxWidth, totalHeight, BufferedImage.TYPE_INT_ARGB);
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(c == btn_dir){
            ...
            if(checkValues()){
                makeSprite();
                Icon iv = new ImageIcon(sprite);
                lbl_spriteImage.setIcon(iv);
//                lbl_spriteImage.setIcon((Icon)sprite.getGraphics());
